  ...
  return (
    <div className=" bg-white border-y-[1px] border-[#f1f1f1]">
      <div className="lg:w-[80%] mx-auto p-4">
        <div className="mt-2">
          <h1 className="lg:text-3xl text-xl font-montserrat text-center font-extrabold">
        ...
        <div className="flex flex-col lg:flex-row mt-3 lg:mt-10 gap-10">
          <div className="flex lg:w-1/3 flex-col-reverse justify-center items-center border-[1px] rounded-lg border-[#f1f1f1] mb-4">
          ...
          <div className="flex lg:w-1/3 flex-col items-start border-[1px] rounded-lg border-[#f1f1f1] mb-4">
            <div className="">
              <img
                src={confidence}
                alt=""
          ...
          <div className="flex lg:w-1/3 flex-col items-start border-[1px] rounded-lg border-[#f1f1f1] mb-4">
            ...
            <div className="text-center p-4">
              ...
              <p className="font-bold lg:text-2xl text-xl">Committed team</p>
              <p>
                Our unwavering{" "}
        ...
        <div className="mt-5 justify-center flex lg:hidden">
          <Link to={"sign_in"}>
