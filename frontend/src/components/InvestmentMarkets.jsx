  ...
  return (
    <div className="border-y-[1px] mt-5 bg-white border-[#f1f1f1]">
      <div className="w-[80%] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-0 gap-3 mt-4 p-3  justify-between">
          <div className="flex bg-[#fafafa] lg:w-1/4 rounded-md border-[1px] border-[#f1f1f1]">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-0 gap-3 lg:mt-2 mb-5 p-3 justify-between">
          <div className="flex bg-[#fafafa] lg:w-1/4 rounded-md border-[1px] border-[#f1f1f1]">
            <div className="mr-3 bg-[#33337c] w-14 text-center p-3 text-white rounded-md">
              ETF's
            </div>
